...
path_params.add_argument('site_id', type=str, location='args')
...
class Hoteis(Resource):
    def get(self):
        ...
        conn.close()  # Fechou o banco de dados
...
class Hotel(Resource):
    ...
    argumentos.add_argument('site_id', type=int, required=True, help='Every hotel needs to be linked with the site')
    ...
    def post(self, hotel_id):
        if HotelModel.find_hotel(hotel_id):
            return {"message": f"Hotel id '{hotel_id}' already exists."}, 400 #Badrequest
